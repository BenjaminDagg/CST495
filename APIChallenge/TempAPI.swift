...
class TempAPI {
    ...
    static func getData(name:String, units:String, handler: @escaping (WeatherResult)->Void) {
        ...
        //json call to api
        Alamofire.request("http://api.openweathermap.org/data/2.5/weather?APPID=\(apiKey!)&q=\(name)&units=\(units)", method: .get,
